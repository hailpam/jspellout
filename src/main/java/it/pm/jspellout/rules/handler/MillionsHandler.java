...
/**
 * Manages numbers of millions order of magnitude.
 * 
 * @author Paolo Maresca <plo.maresca@gmail.com>
 */
public abstract class MillionsHandler implements RulesHandler
{
    // successor in the processing pipeline
    private ThousandsHandler pipeSuccessor;
    // successor to be used in case of composite billions
    private HundredsHandler compositeHandler;
    // number of digits expected - from
    private static final int NR_DIGITS_FROM = 7;
    // number of digits expected - to
    private static final int NR_DIGITS_TO = 9;
    ...
    public void manageDigits(int[] digits, Queue<SpellResult> results) throws SpellOutException {
        ...
        System.out.println("[Pipeline][MillionsHandler]");
    }

    public ThousandsHandler getPipeSuccessor() 
    {
        return pipeSuccessor;
    }

    public void setPipeSuccessor(ThousandsHandler pipeSuccessor) 
    {
